...
### Import the Data
```{r}
setwd('C:/Users/Tokyo/Desktop/MSDS/Math6359 Multivariate Statistics/Project Data')
...
The following is a look at weekly sales by state. First, CA
```{r}
...
```{r}
weekly_sales = cbind(CA_weekly[,3], TX_weekly[,3], WI_weekly[,3])
weekly_sales 
```

```{r}
colnames(weekly_sales)[1] = 'CA Sales'
colnames(weekly_sales)[2] = 'TX Sales'
colnames(weekly_sales)[3] = 'WI Sales'
```
